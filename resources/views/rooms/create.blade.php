...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
    <div class="container px-6 py-8 mx-auto">
        ...
        <form class="mt-8 p-6 rounded-lg bg-white grid grid-rows-[auto_auto_auto] grid-cols-1 gap-4" action="/rooms" method="POST">
            @csrf
            <div class="grid md:grid-cols-2 grid-cols-1 md:grid-rows-1 grid-rows-[auto_auto] gap-4 items-start">
                <div class="grid grid-cols-1 grid-rows-[auto_auto] gap-2">
                    ...
                    <input type="number" name="number" id="number" class="text-black border @error('number') border-red-500 @enderror rounded-lg w-full p-2" placeholder="Enter number..." value="{{ old('number') }}"/>
            ...
            <div class="grid md:grid-cols-2 grid-cols-1 md:grid-rows-1 grid-rows-2 gap-4">
                ...
                <div class="grid grid-cols-1 grid-rows-[auto_auto] gap-2">
                    ...
                    <input type="number" name="price" id="price" class="text-black border rounded-lg w-full p-2" value="" />
                </div>
            </div>
